...
class ProjectSerializer:
    ...
    def validate(payload: Mapping[str, Any]) -> None:
        ...
        if decoded.get("schema_version") != PROJECT_SCHEMA_VERSION:
            raise ProjectPersistenceError(
                "JSON 驗證失敗", "schema_version 不符合目前版本"
            )
